...
terminal = "urxvt"
browser  = "google-chrome-unstable --disable-session-crashed-bubble"
email    = "thunderbird"
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ " [(1) http ] ", " [ (2) mail ] ", " [ (3) system ] ",
    " [ (4) term ] " ," [ (5) vim ] ", " [ (6) term ] ",
    " [ (7) tasks ] ", " [ (8) misc ] ",
    " [ (9) torrent ] " }, s, layouts[1])
end
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "e",      function () awful.util.spawn(email) end),
